...
export const JobFailed = ({ onReset }: Props) => {
  return (
    <div role="alert" className="text-center h-full flex flex-col">
      <div className="size-20 rounded-full bg-(--critical-secondary) flex items-center justify-center mx-auto mt-4">
        <WarningIcon />
      </div>
      <h2 className="mt-6 text-[22px] font-bold text-(--blue-900)">Hmm, something went wrong</h2>
      <p className="text-sm text-(--critical-secondary) leading-normal max-w-[280px] mx-auto mt-2">
